...
//		txtDataAta = new JFormattedTextField(dateMask);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(txtrConteudo.getText().trim().equals("")&&txtrPresentes.getText().trim().equals("")){
					...
					try {
						...
						connAta.insertAta(Integer.parseInt(txtNumeroAta.getText()), getDate(), txtrConteudo.getText(), txtrConteudo.getText());
	...
	private void retornaValorConsultado(String comando, String id){
		...
		}else if(retornoConsulta.get(0).equals("VAZIO") && comando.equals(">")){
			iniciaComponentes();
		}else{
			txtNumeroAta.setText(retornoConsulta.get(0));
			txtDataAta.setText(retornoConsulta.get(1));
